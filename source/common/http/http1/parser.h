...
public:
   ...
   */
   // 完成 Decoder 和 Encoder 的初始化, 后面流程都会用。
   ...
   */
   // 解析 http 的 header 信息结束的时候, 调用本方法。
