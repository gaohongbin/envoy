...
#endif
  // main_thread 在这里看似只是生命, 但是在 C++ 里面会调用 MainThread 默认的构造函数。默认构造函数将本线程声明为主线程。
  // TODO gaohongbin
  // 考虑将泳道的 map 加在本线程中。即将 map 放在 MainCommon 类中。
